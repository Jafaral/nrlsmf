...
| `chained_clouds/` | All five of those modes chained together end to end across five segments, connected only by nrlsmf relaying (never IP routing) |
